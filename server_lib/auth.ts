 ...
 * the URL could run arbitrary PDFs through this function on the owner's
 * Netlify plan. This is a single shared secret, not per-user auth: adequate
 * for a one-person private tool, and the seam to replace
