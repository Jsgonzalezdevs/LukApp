...
export const PASOS_BASICOS: PasoGuia[] = [
  ...
  },
  {
    ...
    texto:
      'Cuentas, categorías propias, topes de gasto, metas de ahorro, pagos fijos, extractos del banco, el 4x1000 y Vaquitas. Es la puerta que menos se ve y la que más guarda.',
    aire: 4,
    radio: 14,
  },
];
